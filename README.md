...
- Lock-screen Live Activity mini-remote with interactive App Intent buttons (d-pad, media, volume, power) designed to work without unlocking; lock-screen behavior still needs physical-device validation.
